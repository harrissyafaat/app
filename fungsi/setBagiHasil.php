...
$qt = mysqli_query ($koneksi, "SELECT tgl_hitung FROM t_bagihasil ORDER BY id DESC LIMIT=1");
$rt = mysqli_fetch_array($qt, MYSQLI_ASSOC);
$tgl_hitung = $rt[tgl_hitung];
echo $tgl_hitung;

// Looping untuk setiap anggota
function hitung_bagihasil()
{
